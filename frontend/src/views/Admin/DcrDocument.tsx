...
export const DcrDocument: React.FC<{ defaultLeadId?: string; isEmbedded?: boolean }> = ({ defaultLeadId, isEmbedded }) => {
  ...
  return (
    <div className={isEmbedded ? "h-[650px] bg-slate-50 flex flex-col border border-slate-200 rounded-xl overflow-hidden shadow-xs" : "min-h-screen bg-slate-50 flex flex-col -mx-4 -my-6 md:-mx-8 md:-my-8"}>
      ...
      {/* Header bar */}
      {!isEmbedded && (
        <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shrink-0 select-none dcr-header-bar">
